...
Wiki version:: David McLeod, 2018-2019. Available in
http://cosmoglotta.pbworks.com[cosmoglotta.pbworks.com], also in PDF.

This e-book version, based on the wiki version:: Marcos Cruz, 2019.
Available from http://ne.alinome.net[ne.alinome.net].  in EPUB, PDF
and other formats.
