...
:revnumber: 0.3.0-dev.21.0+20201119
...
//
// Last modified 202011191748

// NOTE: Most of the corections done in this edition are marked with
// "XXX FIXED", for reference, but not all of them. Specially most
// corections done in version 0.3.0 are not marked in this source
// file. See the project's repository for a full history of changes.
...
Currently both names are used as synonyms, as well as compounds
...
series A, number 101, 1935-03. Note of the digital editor.]: *chambre*.
...
- The endings *-bil*, *-ic* (only if it's pronounced
  "`ik`"footnote:[See "`Complet grammatica de Occidental`" in
  Cosmoglotta series A, number 65, 1929-10. Note of the digital
  editor.]), *-im*,
...
// Words formed by prepositions {{{4
...
Some other examples Edgar de Wahl mentioned in
Cosmoglotta{blank}footnote:[See article "`Esque vermen Occidental es
caotic?`" in Cosmoglotta series B, number 10, 1937-04. Note of the
digital editor.]:
...
precision, and a subject mentioned in
Cosmoglotta{blank}footnote:[See article "`Quo es correct Occidental?`" in
Cosmoglotta series B, number 31, 1942-02. Note of the digital editor.]
before. Because <<_ica_and_ico,*-ica*>>
...
object of a verb and others don't, Interlingue prefers to not use them.
