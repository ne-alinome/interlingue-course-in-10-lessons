...
Date of the original edition:: 1929.

Translation, orthographic modernization and new additions:: David
MacLeod, 2019.

Original title of the English version:: Occidental Course in 10
Lessons (English translation)

Editor of the wiki version:: David McLeod, in
http://cosmoglotta.pbworks.com[cosmoglotta.pbworks.com], 2018-2019.
Available also in PDF.

Editor of this e-book version, based on the wiki version:: Marcos Cruz
(programandala.net) for http://ne.alinome.net[ne.alinome.net], 2019.
Available in EPUB, PDF and other formats.
