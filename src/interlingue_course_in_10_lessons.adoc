...
having the qualities of a verb: *timid* = timid (*timer* = to
fear, *timore* = fear), *frigid* = cold, frigid (*friger* = to feel
cold, *frigore* = cold)

===== -nd

Mentioned once in a note above: what is to be done. *quo esset
...
*fructiferi* (fruit-bearing), *mammifere* (a mammal)
...
are permitted.
Examples: *noctal* = *nocturn*, *terral* = *terrestri* (terrestrial),
*cielal* = *celest* (celestial), *patrin* = *paternal* (paternal).
...
*Nor lingue fa un constant progress que* (= *quel facte*) *tre joya me*.
...
// XXX FIXED -- the second "more" was missing:
...
*Il venit _ante_ quin annus.* = He came five years ago. (*quin annus* on
its own is not a phrase)

*Il venit _ante que_ il hat trovat it.* = He came before he had found
...
*Il luctat _por_ su país.* = He fought for his country. (*su país* is not
a phrase)

*Il luctat _por_ protecter su país.* = He fought to protect his country.
(*protecter su país* is also not a phrase)

// XXX FIXED -- wha -> who

*Il luctat _por que_ su filies mey saver qui hat protectet lor país.* =
...
children know who had protected their country -- is a phrase!)
