...
Original title in German:: Unknown.

Original publisher:: Occidental-Buró Berlin.

Date of the original edition:: Unknown.

Author of the English version:: Unknown.

Original title of the English version:: Occidental Course in 10 Lessons.

Editor of the wiki version:: Dave McLeod, in
http://cosmoglotta.pbworks.com[cosmoglotta.pbworks.com], 2018.

Editor of this e-book version:: Marcos Cruz (programandala.net) for
http://ne.alinome.net[ne.alinome.net], 2019. Available in EPUB, PDF
and other formats.
...
|===
| *monastere*  | monastery            | *tranquilmen* | tranquilly
| *multvez*    | many times           | *exclama*     | exclaims
| *nam*        | because              | *tu erra*     | you err (=are wrong)
| *patre*      | father               | *mem*         | even
| *mi filio*   | my son               | *yo ha leet*  | I have read
| *mentiona*   | mentions             | *esser*       | be
| *responde*   | responds             | *tui ocul*    | your eye
| *macul*      | spot                 | *turre*       | tower
| *yun monaco* | young monk           | *sede*        | sits
| *hasta*      | rushes (lit. hastes) | *tra*         | through
| *hasard*     | chance               |               |
|===
...
|===
| *ninant*    | ninety               | *compane*     | companion
| *diminuent* | smaller, diminishing | *nin*         | nine
| *divide*    | divide, share        | *plu durabil* | more durable
| *lor*       | their                | *si*          | if
| *quam*      | than                 | *tot*         | entire, whole
| *dómina*    | dominates            | *destructe*   | destroys
| *felicie*   | happiness, fortune   | *sol*         | sole, only
| *nos*       | us                   |               |
|===
...
| *difamar*    | speak ill of (cf. defamation)   | *imperar*    | order (cf. imperative)
...
|===
| *eterni*      | eternal         | *témpore*   | time
| *coronar*     | to crown        | *semblar*   | to seem
| *van*         | in vain         | *evoluer*   | evolve
| *ti*          | this, that      | *explorar*  | explore
| *retirar*     | retire          | *pensa*     | thought
| *guerre*      | war             | *detronar*  | dethrone
| *devot*       | devoted         | *penetrar*  | penetrate
| *devenir*     | become          | *abandonar* | abandon
| *defender*    | defend          | *malgré*    | despite
| *adavan*      | forwards        | *spíritu*   | spirit
| *omni*        | all             | *choc*      | shock
| *justificar*  | justify         | *misprense* | misunderstanding
| *les*         | them            | *erra*      | error
| *nor*         | our             | *sequer*    | follow
| *pos*         | after           | *strett*    | narrow
| *fluctuar*    | fluctuate       | *sómmite*   | summit
| *propri*      | own (one's own) | *unde*      | wave
| *Renascentie* | Renaissance     | *indicar*   | indicate
| *imitar*      | imitate         | *culminar*  | culminate
| *támen*       | however         | *fórsan*    | perhaps
| *senil*       | senile          | *fatiga*    | fatigue
| *creder*      | believe         |             |
|===
...
NOTE: The perfect stem plus an *-e* (to indicate a noun) is also used
...
- *un devot amico* = a devoted friend (from *devoer* = devote). In
...
| *renascer* | be reborn (cf. renaissance, *renascentie* in Interlingue) | *flore*     | flower
| *nive*     | snow                                                      | *calid*     | hot
|===
...
| *cri*       | a cry         | *inpallidar* | to bleach (also *pallidar*, *in-* strengthens the verb a bit as in to bleach in)
...
| *pur*          | pure
| *calv*         | bald
| *dispensar* a* | to dispense, rid oneself of
| *necos a*      | nothing (n.b. derived from *ne* + *cose*, thus accented as *necós* and often written with the accent)
| *glacie*       | ice
...
"To make into something", "to bring towards" - similar to *-isar*
above but slightly different.

====

- *electrificar* = to electrify (note the difference between this and
  *electrisar* above. *Electrisar* means to make something electric,
  ...
  *electrisa* one's room, while equipping a village with power cables
  with *electrifica* it. Though such subtle differences are not too
...
We have already gone over the suffixes *-ion* and *-ura* in chapter 3.
...
"O," su response esset, "forsan quar o quin."
...
- *Li diferentie inter mi e tui* = The difference between mine and
  yours *Li nores victet li vores* = Ours (plural) beat yours
  (plural).  If *noi* had had one and *vu* had also had had one, it
  would be expressed as *Li nor victet li vor*.
