...
- *confirmar* = confirm
- *dar* = give
- *deposir* = put in / deposit
- *dir* = say
- *durant que* = while
- *esque* = (asked to ask questions)
- *fin* = fine
- *furtard* = thief
- *furter* = steal
- *gilete* = vest
...
- *anc* = also
- *conceder* = concede
- *difamar* = speak ill of (cf. defamation)
- *donar* = give, donate
- *evocar* = evoke
- *exagerar* = exaggerate
- *extender* = extend
...
- *imperar* = order (cf. imperative)
- *innovar* = innovate
- *intervenir* = intervene (lit. "between-come")
- *ja* = already
- *necessi* = necessary
- *negociar* = negotiate
- *preceder* = precede
- *quande* = when
- *succeder* = succeed (follow)
- *transacter* = transact
...
- *abrogar* = abrogate, repeal
- *alqui* = someone
- *antey* = before
- *avan* = before
- *besonar* = to need
- *distinter* = distinguish
...
- *nive* = snow
- *quel* = which
- *renascer* = be reborn (cf. renaissance, *renascentie* in Interlingue)
- *secul* = century
- *semane* = week
- *verne* = spring
...
- *inclinar* = to incline, tend
- *indolentie* = indolence
- *insister* = to insist
- *intrar* = to enter
- *lege* = law
- *luctar* = to fight, struggle
- *líttere* = letter
- *monstrar* = to show
- *mover* = to move
- *negar* = to deny
...
- *calv* = bald
- *chascun* = each
- *dispensar* = to dispense, rid oneself of
- *fix* = fixed, fast
- *glacie* = ice
- *luder* = to play
- *lurar* = to lure
...
- *luder* = to play
- *monete* = a coin
- *partiprender* = to participate, take part
- *rasar* = to shave
